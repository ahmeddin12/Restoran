            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-6 text-start">
                        <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="{{ asset('assets/img/about-1.png')}}">
                    </div>
                    <div class="col-6 text-start">
            ...
            <div class="tab-content">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center">
                                <img class="flex-shrink-0 img-fluid rounded" src="{{ asset('assets/img/' . $food->image) }}" alt="" style="width: 50px; height: 50px; object-fit: cover;">
                ...
                <div id="tab-3" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center">
                                <img class="flex-shrink-0 img-fluid rounded" src="{{ asset('assets/img/' . $food->image) }}" alt="Food Image" style="width: 50px; height: 50px; object-fit: cover;">
                                <div class="w-100 d-flex flex-column text-start ps-4">
                                    <h5 class="d-flex justify-content-between border-bottom pb-2">
                                        <span>{{$food->name}}</span>
                                        <span class="text-primary">${{$food->price}}</span>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating date" id="date3" data-target-input="nearest">
                                <input type="text" name="date" class="form-control datetimepicker-input @error('date') is-invalid @enderror" id="datetime" placeholder="Date & Time" data-target="#date3" data-toggle="datetimepicker" value="{{ old('date') }}" />
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control @error('spe_request') is-invalid @enderror" name="spe_request" placeholder="Special Request" id="message" style="height: 100px">{{ old('spe_request') }}</textarea>
