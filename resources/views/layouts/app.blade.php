        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="{{ route('users.bookings') }}">Reservation</a>
                    <a class="btn btn-link" href="">Privacy Policy</a>
                    <a class="btn btn-link" href="">Terms & Condition</a>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Contact</h4>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>453 Street, Cydney, Australia</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+61 26 844 342</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Subscribe to our newsletter for the latest updates, special offers, and delicious recipes!</p>
